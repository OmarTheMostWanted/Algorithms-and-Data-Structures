package main.code.Book.Ch11BST;

import main.code.Book.Ch10Maps.AbstractSortedMap;
import main.code.Book.Ch7PositionalList.Position;
import main.code.Book.Ch8Trees.LinkedBinaryTree;
...
//            if (isInternal(p)) buffer.add(p.getElement());
    ...
    protected static class BalanceableBinaryTree<K, V>
            extends LinkedBinaryTree<Map.Entry<K, V>> {
